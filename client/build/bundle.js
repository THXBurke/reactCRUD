...
/***/ function(module, exports, __webpack_require__) {
	      ...
	      this.state.wine.map(wine => {
	        return React.createElement(
	          ...
	          React.createElement(
	            ...
	            React.createElement(
	              'button',
	              { onClick: this.editWine(wine._id) },
	              ' EDIT '
	            ),
	            React.createElement(
	              'button',
	              { onClick: this.removeWine(wine._id) },
	              ' DELETE '
	            ),
	            ' '
	          ),
	          React.createElement(
	            'form',
	            { id: wine._id, className: wine.editing ? null : 'hidden', onSubmit: this.saveWine },
	            React.createElement('input', { type: 'text', name: 'wine-name', placeholder: 'Wine Name', defaultValue: wine.name }),
	            React.createElement('input', { type: 'text', name: 'wine-description', placeholder: 'Wine Description', defaultValue: wine.description }),
	            React.createElement(
	              'button',
	              { type: 'submit' },
	              ' SAVE WINE'
	...
	var NewWine = React.createClass({
	  ...
	  render: function () {
	    return React.createElement(
	      'form',
	      { onSubmit: this.createWine },
	      React.createElement('input', { type: 'text', name: 'wine-name', placeholder: 'Wine Name' }),
	      React.createElement('input', { type: 'text', name: 'wine-description', placeholder: 'Wine Description' }),
	      React.createElement(
	        'button',
	        { type: 'submit' },
	        'CREATE WINE'
	...
	ReactDOM.render(React.createElement(GetWine, null), document.getElementById('wine-holder'));
	ReactDOM.render(React.createElement(NewWine, null), document.getElementByID('newwine'));

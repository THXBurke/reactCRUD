...
/***/ function(module, exports, __webpack_require__) {
	...
	const superagent = __webpack_require__(168);
	...
	var List = React.createClass({
	  ...
	  handleWineDelete: function () {
	    ...
	    superagent.delete('http://localhost:3000/api/wines' + this.wines._id).end(err => {
	      console.log(err);
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      this.wines.name,
	      ' description: ',
	      this.wines.description,
	      React.createElement(
	        'button',
	        { onClick: this.handleWineDelete, type: 'submit' },
	        'Drink the wine'
	      )
	    );
	  }
	...
	var App = React.createClass({
	  ...
	  handleWineSubmit: function (wines) {
	    superagent.post('http://localhost:3000/api/wines').send(wines).end(err => {
	      console.log(err);
	      this.loadWinesFromServer();
	    });
	  },
	    ...
	    return React.createElement(
	      ...
	      React.createElement(
	        ...
	        this.state.wines.map(wine => {
	          return React.createElement(List, { _id: wine._id, name: wine.name, description: wine.description,
	      ...
	      React.createElement(CreateNewWine, { onWineSubmit: this.handleWineSubmit })
	    );
	  }
	});

	var CreateNewWine = React.createClass({
	  displayName: 'CreateNewWine',
	  ...
	  render: function () {
	    return React.createElement(
	      ...
	      React.createElement('input', { type: 'text', name: 'name', value: this.state.name, onChange: this.nameInput }),
	      React.createElement(
	        'label',
	        { name: 'description' },
	        'description'
	      ),
	      React.createElement('input', { type: 'text', name: 'description', value: this.state.description, onChange: this.descriptionInput }),
	      React.createElement(
	        'button',
	        { type: 'submit' },
	        'Create a Wine'
...
/***/ function(module, exports, __webpack_require__) {
	...
	var request = module.exports = __webpack_require__(173).bind(null, Request);
